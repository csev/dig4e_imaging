...
/**
 * Installation sanity checks for the Dig4E Imaging home page only.
 *
...
function dig4e_imaging_sanity_die($title, $body_html) {
    error_log('Dig4E Imaging sanity: '.$title);
...
$tsugi_url = 'tsugi/';
$repo_dir = 'dig4e_imaging';

if ( ! is_dir($tsugi_dir) ) {
    dig4e_imaging_sanity_die(
        'Tsugi is not installed',
        '<p>This copy of Digitization for Everybody — Imaging expects a <code>tsugi</code> folder next to
...
composer install</pre>
        ...
        <p>More detail: <a href="https://github.com/csev/dig4e_imaging"
        target="_blank" rel="noopener noreferrer">Dig4E Imaging on GitHub</a> and
...
$CFG->apphome = \'https://image.dig4e.com\';

# Local example (adjust host, port, and path):
$wwwroot      = \'http://localhost/dig4e_imaging/tsugi\';
$CFG->apphome = \'http://localhost/dig4e_imaging\';</pre>
