...
// Theme like the Dig4E Imaging site
$CFG->theme = array(
    "primary" => "#9e4f00", // nav background, splash background, buttons, text of tool menu
...
$CFG->context_title = "Digitization for Everybody (Dig4E) - Imaging";
