...
function buildMenu() {
    ...
    $set->setHome('<img src="'.$CFG->apphome.'/images/dig4e-logo-transparent.png" style="height: 1.2em;" alt="Link back to main Digitization for Everybody Site"/>', 'https://www.dig4e.com');
